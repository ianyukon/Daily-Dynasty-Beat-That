...
const s = {
  ...
  hdr:{ width:"100%", padding:"16px 18px", borderBottom:`1px solid ${C.border}`, display:"flex", justifyContent:"space-between", alignItems:"center", position:"sticky", top:0, zIndex:20, backdropFilter:"blur(20px)", WebkitBackdropFilter:"blur(20px)", background:"rgba(7,7,16,0.82)" },
  homeBtn:{ display:"inline-flex", alignItems:"center", gap:6, padding:"8px 14px", borderRadius:999, background:"rgba(255,255,255,0.08)", border:`1px solid ${C.borderBright}`, color:C.text, fontSize:13, fontWeight:800, cursor:"pointer", letterSpacing:0.2, flexShrink:0 },
  ...
  return (
    <div style={s.app}>
      ...
      <div style={s.hdr}>
        ...
        <button className="bt-press" onClick={onExit} style={s.homeBtn}>🏠 Home</button>
      </div>
      <div style={s.wrap}>
      ...
      {!(seedInfo && seedInfo.kind==="challenge") && (
        <div style={s.card}>
          ...
          <div style={{ display:"flex", gap:10, marginTop:12 }}>
            <button className="bt-press" onClick={()=>shareCard(true)} style={{ flex:1, padding:"16px 10px", borderRadius:14, cursor:"pointer", background:accent, color:"#06120c", border:"none", fontWeight:800, fontSize:14, lineHeight:1.3, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:4 }}>
              <span style={{ fontSize:20 }}>🏆</span>
              <span>Share</span>
              <span style={{ fontSize:11, fontWeight:700, opacity:0.8 }}>full team</span>
            </button>
            <button className="bt-press" onClick={()=>shareCard(false)} style={{ flex:1, padding:"16px 10px", borderRadius:14, cursor:"pointer", background:"rgba(255,255,255,0.06)", color:C.text, border:`1.5px solid ${accent}88`, fontWeight:800, fontSize:14, lineHeight:1.3, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:4 }}>
              <span style={{ fontSize:20 }}>🙈</span>
              <span>Share</span>
              <span style={{ fontSize:11, fontWeight:700, opacity:0.8 }}>spoiler-free</span>
            </button>
          </div>
          <div style={{ fontSize:11, color:C.dim, marginTop:8, lineHeight:1.4, textAlign:"center" }}>Full team shows your whole lineup. Spoiler-free is score and grades only.</div>
        </div>
      )}
          ...
          {(() => {
            ...
            return (
              <div>
                ...
                <div style={{ display:"flex", gap:10, marginTop:12 }}>
                  <button className="bt-press" onClick={()=>replyWithScore(false)} style={{ flex:1, padding:"16px 10px", borderRadius:14, cursor:"pointer", background:won?C.green:accent, color:"#06120c", border:"none", fontWeight:800, fontSize:14, lineHeight:1.3, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:4 }}>
                    <span style={{ fontSize:20 }}>🙈</span>
                    <span>Send score</span>
                    <span style={{ fontSize:11, fontWeight:700, opacity:0.8 }}>spoiler-free</span>
                  </button>
                  <button className="bt-press" onClick={()=>replyWithScore(true)} style={{ flex:1, padding:"16px 10px", borderRadius:14, cursor:"pointer", background:"rgba(255,255,255,0.06)", color:C.text, border:`1.5px solid ${accent}88`, fontWeight:800, fontSize:14, lineHeight:1.3, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:4 }}>
                    <span style={{ fontSize:20 }}>🏆</span>
                    <span>Send score</span>
                    <span style={{ fontSize:11, fontWeight:700, opacity:0.8 }}>+ full team</span>
                  </button>
                </div>
                <div style={{ fontSize:11, color:C.dim, marginTop:8, lineHeight:1.4, textAlign:"center" }}>Spoiler-free hides your players — use it if your opponent hasn't drafted yet.</div>
              </div>
            );
          })()}
        </div>
      ...
      {seedInfo && seedInfo.kind==="challenge" && (!seedInfo.opp || ((seedInfo.opp.wins||0)===0 && (seedInfo.opp.losses||0)===0)) && (
        <div style={s.card}>
          ...
          <div style={{ display:"flex", gap:10 }}>
            <button className="bt-press" onClick={()=>replyWithScore(false)} style={{ flex:1, padding:"16px 10px", borderRadius:14, cursor:"pointer", background:accent, color:"#06120c", border:"none", fontWeight:800, fontSize:14, lineHeight:1.3, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", gap:4 }}>
              <span style={{ fontSize:20 }}>🙈</span>
              <span>Send score</span>
              <span style={{ fontSize:11, fontWeight:700, opacity:0.8 }}>spoiler-free</span>
            </button>
...
export default function BeatThat() {
    ...
    return (
      ...
      <div style={s.glow} />
        <div style={s.hdr}>
          ...
          <button className="bt-press" onClick={reset} style={s.homeBtn}>🏠 Home</button>
        </div>
        <div style={s.wrap}>
          {seedInfo && (
  ...
  if (screen==="result") {
    ...
    return (
      ...
      <div style={s.app}>
      <div style={s.glow} />
        <div style={s.hdr}><div style={{ ...s.logo, cursor:"pointer" }} onClick={goHome} title="Back to home">BEAT <span style={{ color:C.gold }}>THAT</span></div><button className="bt-press" onClick={goHome} style={s.homeBtn}>🏠 Home</button></div>
        <div style={s.wrap}>
